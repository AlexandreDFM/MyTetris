...
{
    my_printf("Key left: %s (%d)\n", tetris->key_l, get_key(tetris->key_l,tetris));
    my_printf("Key right: %s (%d)\n", tetris->key_r, get_key(tetris->key_r,tetris));
    my_printf("Key turn: %s (%d)\n", tetris->key_t, get_key(tetris->key_t,tetris));
    my_printf("Key drop: %s (%d)\n", tetris->key_d, get_key(tetris->key_d,tetris));
    my_printf("Key quit: %s (%d)\n", tetris->key_q, get_key(tetris->key_q,tetris));
    my_printf("Key pause: %s (%d)\n", tetris->key_p, get_key(tetris->key_p,tetris));
